sap.ui.define([
	...
	return Controller.extend("ext.samples.employeeonboarding.controller.UserSelection", {

		onInit: function () {
			sap.ui.getCore().getEventBus().subscribe("ext.samples.employeeonboarding", "requestsLoaded", this.fetchUsers, this);
			sap.ui.getCore().getEventBus().subscribe("ext.samples.employeeonboarding", "requestDeleted", this.addUser, this);
		},
		...
		createRequest: function (evt) {
			...
			function handleCreateRequestSuccess(data, textStatus, jqXHR) {
				...
				sap.ui.getCore().getEventBus().publish("ext.samples.employeeonboarding", "requestCreated", data);
			}
