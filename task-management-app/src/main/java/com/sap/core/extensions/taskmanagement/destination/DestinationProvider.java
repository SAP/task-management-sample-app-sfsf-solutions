package com.sap.core.extensions.taskmanagement.destination;
...
public class DestinationProvider {
	...
	private String getServiceName() {
		List<ScpCfServiceInfo> extensibilityServiceInfo = ScpCfServiceInfo.createFor(SERVICE_TYPE);

		if (extensibilityServiceInfo.isEmpty()) {
			throw new IllegalArgumentException("Service from type " + SERVICE_TYPE + " is not bound");
		}

		String serviceName = extensibilityServiceInfo.get(0).getServiceName();
